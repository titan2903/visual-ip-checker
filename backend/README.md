...
Layanan backend untuk **Tarum (Visual IP Checker)** yang bertugas melakukan inferensi embedding visual desain kriya/fashion menggunakan model **CLIP ViT-B/32** dan pencarian kemiripan vektor menggunakan **FAISS**.
